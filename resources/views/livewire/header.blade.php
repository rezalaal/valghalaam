<header class="bg-ghalam text-4xl  text-black flex justify-between items-center px-4">
    ...
    <div class="flex items-center">
        ...
        <label class="toggle text-base-content">
            <input type="checkbox" value="dark" class="theme-controller" wire:click='toggleTheme'/>
    ...
    <div class="fixed bottom-0 left-0 w-full h-12 border-t border-gray-300 flex lg:hidden justify-evenly items-center">
        <a href="/profile" wire:navigate>
            <div class="flex flex-col justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                </svg>
                <p class="text-xs">پروفایل</p>
            </div>
        </a>
